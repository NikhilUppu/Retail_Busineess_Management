...
![home (2)](https://github.com/NikhilUppu/Retail_Busineess_Management.git)
...
1. Clone the repository : $ git clone [https://github.com/NikhilUppu/Retail_Busineess_Management.git] <br>
